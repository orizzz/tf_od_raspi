...
class Blob:
    ...
    '''
    def __init__(self, _bounding_box, _type, _type_value, _confidence, _tracker):
        self.bounding_box = _bounding_box
        self.type = _type
        self.type_value = _type_value if _type_value else 0
    ...
    def update(self, _bounding_box, _type=None, _type_value=None, _confidence=None, _tracker=None):
        self.bounding_box = _bounding_box
        self.type = _type if _type is not None else self.type
        self.type_value = _type_value if _type_value is not None else self.type_value
